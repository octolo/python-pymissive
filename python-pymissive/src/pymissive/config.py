...
MISSIVE_FIELDS_EMAIL = {
    ...
    "body_html": {
        "label": "Body HTML",
        "description": "HTML body (email) or rich content (postal)",
        "format": "str",
    },
    "body_text": {
        "label": "Body Text",
...
# Keys = DB value (lowercase), values = display (capitalize)
# DB values (lowercase). Display = capitalize
MISSIVE_PRIORITIES = ["low", "normal", "high", "urgent"]
MISSIVE_DELIVERY_MODES = ["economic", "normal", "premium", "express"]

# Keys = Python constant (uppercase), values = missive types
# Keys = DB value (lowercase), values = missive types for this support
MISSIVE_GENERIC_SUPPORT = {
    "email": ["email", "email_marketing", "lre", "ere"],
